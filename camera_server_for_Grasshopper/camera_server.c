/* 
   ...
   (specialized for PointGrey Research grasshopper3 camera)
*/
#include <stdio.h>
#include <cv.h>
#include <highgui.h>
...
/* header file for PGR grasshopper */
...
int main(void) {
    ...
    while(1) { 
        ...
        //        if(cvWaitKey(300) == 0x1b) break; /* wait 2ms(delay after writing image to shared memory) */
